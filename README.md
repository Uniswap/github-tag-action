...
- **scopes** _(optional)_ - Comma separated list of scopes (case-insensitive) to consider when tagging, and to include in the changelog. If this option is specified, then commits with scopes not included in this list will not be analyzed or included in the changelog.
